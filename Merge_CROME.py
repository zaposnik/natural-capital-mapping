...
repository = r"Z:\NatCap_v2\Data\LADs_Output"
LADs = os.listdir(repository)

if region == "Oxon" and method == "HLU":
    data = r'Z:\NatCap_v2\Data.gdb'
    CROME_data = r'Z:\NatCap_OS\RPA_CropMapOfEngland2020OXF_SHP_Full\data\Crop_Map_of_England_2020_Oxfordshire.shp'
...
lookupTable = r'Z:\NatCap_v2\Data\CROME_LUCODE_LOOKUP.dbf'
if prep_CROME:
    print('Dissolving CROME by Land Use Code')
    arcpy.Dissolve_management(CROME_data, "CROME_data_prepped", dissolve_field="lucode", multi_part="MULTI_PART")
    CROME_data = os.path.join(data, 'CROME_data_prepped')
    print('Joining to Land Use Code Table')
    arcpy.JoinField_management(CROME_data, 'lucode', lookupTable, 'LUCODE')
...
for LAD in LADs:
    ...
    if merge_CROME:
        ...
        expression = Hab_field + " IN ('Agricultural land', 'Cultivated/disturbed land', 'Arable', 'Arable and scattered trees','Natural surface') OR (" + Hab_field + " LIKE 'Improved grassland%')"
        ...
        arcpy.CalculateField_management("ag_lyr", out_map + ".CROME_desc", "!CROME_TI_sort.Land_Use_Description!",
                                        "PYTHON_9.3")
